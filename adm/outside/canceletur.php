          ...
          <div class="header-menu">
              ...
              <div class="col-sm-1">
                  <a id="menuToggle" class="menutoggle pull-left"><i class="fa fa fa-tasks"></i></a>
							...
							<div class="col-sm-2">
								<a href="cancel-bag.php"><button style="border-radius:10px;" type="button"  name="" class="btn btn-info textfont"><i class="ti-shopping-cart-full"></i>Göster</button>

						</a>	  </div>
              <form class="" action="canceletur.php" method="post">
 ...
 ?>
      ...
      <div class="content mt-3">
        <?php
            ...
            $query = "SELECT * FROM ord LEFT JOIN cust ON ord.costid = cust.id where !(`canceled` IS NULL OR `canceled`='') AND (`comp` IS NULL or `comp`='') AND send ='$i' ORDER BY time DESC LIMIT $offset, $no_of_records_per_page;" ;
						                ...
						                <div class="modal-content">
						                    ...
						                    <div class="modal-footer">
						                      ...
						                      <form action="acc_code.php" method="POST" class="float-left"  enctype="multipart/form-data">
						                        ...
						                        <button  type="submit" name="uncancelmain" class="btn btn-danger">Evet</button>
