  ...
  <aside id="left-panel" class="left-panel" style="background-color:#b03060;">
    ...
    <div id="right-panel" class="right-panel ">
        ...
        <header id="header" class="header">
					...
					<div class="col-sm-6">
				<a href="canceletur.php">			<button style="border-radius:10px;" type="button" name=""  class="btn btn-info textfont"><i class="ti-shopping-cart-full"></i>cancle item</button>
					</a>
					</div>
            <div class="col-sm-5">
        ...
        <div class="breadcrumbs">
				...
				<div class="content mt-3">
					...
					$query = "SELECT * FROM ord where `conf`>0 AND !(`canceled` IS NULL OR `canceled`='') AND(  `arrive` IS NULL or `arrive`='')  AND (`comp` IS NULL or `comp`='') AND send='$i' group BY bagid DESC" ;
                  ...
                  $count=1;
                                    ...
                                    <td><h4><center><?php echo $row['iq'];?></h4></center></td>
																...
																<td>	<?php
                                $query1 = "SELECT * FROM ord where `bagid`=$sd AND !(`canceled` IS NULL or `canceled`='')  LIMIT 4  " ;
