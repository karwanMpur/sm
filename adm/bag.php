					...
					<div class="card" style="border-radius:10px;background-color:">
							...
							<div class="card-body" style="">
								<div class="col-sm-2" style="margin-bottom:15px;">
									...
									document.getElementById('extrashippf').value=extra;
									...
									cargoo = document.getElementById('car').value;
										...
										document.getElementById('remf').value=te.toFixed(2);
									 document.getElementById('totall').value=final_price;
									 document.getElementById('totallf').value=final_price;
...
<center>
			<div class="col-sm-2">
				...
				<input type="hidden" name="id" id="fff" value="">
					<input type="hidden" name="bid" id="" value="<?php echo $id; ?>">
				...
				<input type="hidden" id="extrashippf" name="extrashippingfee" value="">
				...
				<input type="hidden" name="dprice" value="<?php echo $convert; ?>">
				...
				<div class="table-responsive">
				        ...
				        ?>
				                    <tr>
				                        ...
				                        <td><center><h3><a href="<?php echo $row['link'];?>" target="_blank">Visit </a></h3></center></td>
				                        <td><?php echo $row['color'];?></td>
				                        <td><?php echo $row['size'];?></td>
				                        <td><?php echo $row['price'];  $payy=$row['paid'];?></td>
				                        ...
				                        <td>
				                            ...
				                            <a class="btn btn-success" style="border-radius:5px;" href="#edit<?php echo $row['oid'];?>" data-toggle="modal"><i class="fa fa-edit white"></i></a>
																		<?php
																				include('onebag/editmodal.php');
																		?>
				                          </td>
																	...
																	<td>
																			<a class="btn btn-danger" style="border-radius:5px;"  href="#del<?php echo $row['oid'];?>" data-toggle="modal"><i class="fa fa-trash white"></i></a>
																		<?php
																				include('onebag/deletemodal.php');
																		?>
																</td>
				                    </tr>
															...
															<div class="modal-dialog modal-lg-8" role="document">
																<div class="modal-content">
																	<div class="modal-header">
																		<h5 class="modal-title" id="exampleModalLabel">Add new Order To This Bag </h5>
																 ...
																 <input type="hidden" name="nid" value="">
																	...
																	<input type="hidden" name="costid" value="<?php echo $personal;?>">
																 <div class="card-body card-block">

																				 <div class="row form-group">
																						 <div class="col col-md-3"><label for="text-input" class=" form-control-label">Web Link : </label></div>
																						 <div class="col-12 col-md-9"><input type="text" name="link" value="" placeholder="Enter Web Link .." class="form"></div>
																				 </div>
																				 <div class="row form-group">
																						 <div class="col col-md-3"><label for="text-input" class=" form-control-label">Color : </label></div>
																						 <div class="col-12 col-md-9"><input type="text" name="color" value="" placeholder="Enter Color .." class="form"></div>
																				 </div>
																				 <div class="row form-group">
																						 <div class="col col-md-3"><label for="text-input" class=" form-control-label">Size : </label></div>
																						 <div class="col-12 col-md-9"><input type="text" name="size" value="" placeholder="Enter Size .." class="form"></div>
																				 </div>
																				 <div class="row form-group">
																						 <div class="col col-md-3"><label for="text-input" class=" form-control-label">Price : </label></div>
																						 <div class="col-12 col-md-9"><input type="text" name="price" value="" placeholder="Enter Price .." class="form"></div>
																				 </div>
																				 <div class="row form-group">
																						 <div class="col col-md-3"><label for="text-input" class=" form-control-label">Image : </label></div>
																						 <div class="col-12 col-md-9"><input type="file" accept="image/*" name="img" placeholder="" class="form"></div>
																				 </div>
																	...
																	<div class="modal-footer">
																		...
																		<button type="submit" name="insert" class="btn btn-info textfont">Save</button>
																	</div>
																</form>
				    ...
				    <div align="" class="col-sm-12" style="">

				     <button type="button" data-toggle="modal" name="add" data-target="#addadminprofile" style="background-color:#fbfbfb;border-radius:20px;" class="btn btn-block btn-xs"><img src="../images/pl.png" alt=""></button>
				    </div>
			...
			<div class="col-md-3"  style="" >
									<div class="card" style="border-radius:10px;margin-bottom: 0px;margin-bottom:2%;">
											<div class="card-header" style="border-radius:10px;color:black;">
												...
												<i class="fa fa-dollar"></i> <input  type="text" style=" border-radius:10px;width:65%;text-align:center; ;margin-top:5px" name="totall" id="totall" value="" readonly></input>
												  </center>
											</div>
									...
									<div class="card" style="border-radius:10px;margin-bottom: 0px;margin-bottom:2%;">
											<div class="card-header" style="border-top-radius:10px;;color:black;">
												...
												<div class="row form-group">
														<div class="col col-md-4"><label for="text-input" class=" form-control-label">	<i  class="fa fa-dollar">&nbsp;Balance</i></label></div>
														<div class="col-12 col-md-8"><h2><input type="text" style="border-radius:10px;text-align:center;"  name="paidd" id="paid" value="<?php echo $payy; ?>"  class="form-control form-control-lg col-sm-6 float-right"></div></h2>
												</div>
											</div>
									...
									<div class="card" style="border-radius:10px;margin-bottom: 0px;margin-bottom:2%;">
											<div class="card-header" style="border-top-radius:10px;color:black;">
												...
												<div class="row form-group">
														<div class="col col-md-3"><label for="text-input" class=" form-control-label"><i class="fa fa-dollar">&nbsp;CustomFee</i></label></div>
														<div class="col-12 col-md-9"><h2><input type="text" style="border-radius:10px;text-align:center;"  id="extrashipp" name="extrashippingfee" value="0" class="form-control form-control-lg col-sm-6 float-right"></div></h2>
												</div>
												<div class="row form-group">
														<div class="col col-md-3"><label for="text-input" class=" form-control-label"><i  class="fa "> &nbsp;Quantity</i></label></div>
														<div class="col-12 col-md-9"><h2><input type="text" style="border-radius:10px;text-align:center;"  id="itemmm" name="itemmm" value="<?php echo $iq; ?>" readonly class="form-control form-control-lg col-sm-6 float-right"></div></h2>
												</div>
									...
									<div class="card" style="margin-bottom:2%;">
											<div class="card-header" style="border-top-radius:10px;;color:black;">
												<div class="row form-group">
														<div class="col col-md-3"><label for="text-input" class=" form-control-label"><i class="fa fa-">&nbsp;CargoFee</i></label></div>
														<div class="col-12 col-md-9"><h2><input type="text" style="border-radius:10px;text-align:center;"  name="cargofee" id="car" value="<?php echo $cargoo; ?>" class="form-control form-control-lg col-sm-6 float-right"></div></h2>
												</div>
												<div class="row form-group">
														<div class="col col-md-3"><label for="text-input" class=" form-control-label"><i style="margin-top:10px;" class="fa fa-try">Total</i></label></div>
														<div class="col-12 col-md-9"><h2><input type="text" style="border-radius:10px;text-align:center;"  id="til" name="totaltil"  readonly value="<?php echo $tott; ?>" readonly class="form-control form-control-lg col-sm-6 float-right"></div></h2>
												</div>
