             ...
             <div id="main-menu" class="main-menu collapse navbar-collapse">
                 <ul class="nav navbar-nav">
                     <li class="active">
                         ...
                         <a href="custmar.php"> <i class="menu-icon  ti-shopping-cart-full"></i><bp style="color:#ffffff;">  Active Orders<bp></a>
                             <hr style="margin-top:0%;margin-bottom:2%;">
                     </li>
                     <li class="active">
                     ...
                     <li class="">
                         <a  href="orderk.php"> <i class="menu-icon fa fa fa-comments"></i><bp style="color:#ffffff;">  Kurdish  <bp></bp></a>
                           <hr style="margin-top:0%;margin-bottom:2%;">
                     </li>
                     <li class="active">
    ...
    <div id="right-panel" class="right-panel" >
      ...
      <!-- Header-->
                              ...
                              <?php
                               ...
                               ?>
															...
															<div class="content mt-4" style="margin-top:10%;">
														        ...
														        <div class="col-5">
														          <button type="button" style="border-radius:10px;background-color:#00BFFF;border-style: none;" onclick="chang()" class="btn btn-success btn btn-xl ">Estimated Price $</button>
        ...
        <form class="" action="insert.php" method="post">
				...
				<button type="submit" style="background-color:#b03060;border-radius:10px;border-style: none;"  onclick="changg()" name="save" id="save" class="btn float-right btn-primary"> Confirm</button>
    ...
    <div class="modal fade " id="del"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg-8" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add New Order To Your Bag</h5>
         ...
         <div class="card-body card-block">
                 ...
                 <div class="form-group">
                     <div class="input-group">
                         <div class="input-group-addon col-2">color</div>
                 ...
                 <div class="form-group">
                     <div class="input-group">
                         <div class="input-group-addon col-2">Size </div>
                 ...
                 <div class="form-group">
                     <div class="input-group">
                         <div class="input-group-addon col-2">Price</div>
                 ...
                 <div class="form-group">
                     <div class="input-group">
                         <div class="input-group-addon col-2">Note</div>
                 ...
                 <div class="form-group">
                     <div class="input-group">
                         <div class="input-group-addon col-2">Image</div>
     ...
     <center><div style="width:20%;hight:38%;" hidden id="uploaded_image"></div> </center>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary textfont" style="border-radius:5px;" data-dismiss="modal">Cancel</button>
            <button type="submit" name="updatebtn" hidden  style="border-radius:5px;" id="suv"  class="btn btn-info textfont">Savehiden</button>
            <button type="button" name="up"  style="border-radius:5px;" onclick="crop()" class="btn btn-info textfont">Save</button>
          </div>
        </form>
                     ...
                     <div class="card">
                         <div class="card-body">
                             ...
                             <div class="card-header text-sm-left" style="width:50%;border-radius:15px;height:35px;padding-top: 5px;">
                               <strong > Price: <?php echo intval($row['price']);?>  </strong>
                             </div>
                             <div class="card-header text-sm-left" style="width:50%;border-radius:15px;height:35px;padding-top: 5px;">
                             ...
                             <div class="" style="margin-top:10%;border-radius:15px;height:35px;padding-top: 5px;">
                               <strong style="margin-top:5px;"><center><a class="btn btn-danger" style="border-radius:10px;"   href="#del<?php echo $row['oid'];?>" data-toggle="modal"><i class="white">Delete</i></a></center></strong>
                             </div>
                         </div >
                   </div>
                 </div>
                          ...
                          <div id="del<?php echo $row['oid']; ?>"  class="modal fade" style="" id="smallmodal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                          <div class="modal-dialog modal-sm" role="document">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title" id="smallmodalLabel">Are you sure you want to delete this Order in Your Bag?</h5>
                                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                          <span aria-hidden="true">&times;</span>
                                                      </button>
                                                  </div>
     ...
     <div align="center" class="col-12">
            ...
            <button type="button" style="border-radius:10px;" name="add1" href="#del" data-toggle="modal" id="add1" class="btn btn-success btn-xs">Add New Order</button>
